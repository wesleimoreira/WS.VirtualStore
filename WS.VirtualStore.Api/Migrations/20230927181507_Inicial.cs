        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoriaIcone = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProdutoImagem = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarrinhoId = table.Column<int>(type: "int", nullable: false),
                    ProdutoId = table.Column<int>(type: "int", nullable: false),
                    CarrinhoItemQuantidade = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Categorias",
                columns: new[] { "CategoriaId", "CategoriaIcone", "CategoriaNome" },
                values: new object[,]
                {
                    { 1, "fas fa-spa", "Beleza" },
            ...
            migrationBuilder.InsertData(
                table: "Usuarios",
                columns: new[] { "UsuarioId", "UsuarioNome" },
                values: new object[,]
                {
                    { 1, "Weslei" },
                    { 2, "Janice" }
            ...
            migrationBuilder.InsertData(
                table: "Carrinhos",
                columns: new[] { "CarrinhoId", "UsuarioId" },
                values: new object[,]
                {
                    { 1, 1 },
                    { 2, 2 }
            ...
            migrationBuilder.InsertData(
                table: "Produtos",
                columns: new[] { "ProdutoId", "CategoriaId", "ProdutoDescricao", "ProdutoImagem", "ProdutoNome", "ProdutoPreco", "ProdutoQuantidade" },
                values: new object[,]
                {
